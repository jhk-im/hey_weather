...
class _HeyWeatherAddressCardState extends State<HeyWeatherAddressCard> {
  ...
  Widget build(BuildContext context) {
    ...
    RxInt status = widget
        .status.obs; // 0 -> none, 1 -> edit start, 2 -> drag, 3 -> edit done
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (widget.address?.isRecent == true ||
                                  widget.address?.id == kCurrentLocationId) ...{
                                const Spacer(),
                                HeyCustomButton.tag(
                                  paddingVertical: 4,
                                  paddingHorizontal: 6,
                          ...
                          Container(
                            ...
                            child: SvgUtils.weatherIcon(
                              ...
                              widget.address?.weatherIconName != null
                                  ? '${widget.address?.weatherIconName}_on'
                                  : 'cloudy_on',
                              width: 40,
                              height: 40,
                            ),
