              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                        ...
                        HeyCustomButton.tagWithIcon(
                          ...
                          text: homeTemperature == homeYesterdayTemperature
                              ...
                              : homeTemperature > homeYesterdayTemperature
                                  ? 'home_card_message_2'.trParams({
                                      'count':
                                          '${homeTemperature - homeYesterdayTemperature}'
                                    })
                                  : 'home_card_message_1'.trParams({
                                      'count':
                                          '${homeYesterdayTemperature - homeTemperature}'
                                    }),
                        ),
                        const Spacer(),
                      ],
                    ...
                    Row(
                      children: [
                        HeyCustomButton.tagWithIcon(
                          ...
                          iconName: 'card_rain',
                          text: homeRain == 0 &&
                                  homeRainTimeText.isNotEmpty &&
                                  homeRainPercent > 50
                              ? 'home_card_message_4'.trParams({
                                  'time': homeRainTimeText,
                                  'percent': '$homeRainPercent'
                                })
                              : homeRain == 0
                                  ? 'home_card_message_5'.tr
                                  : homeRain > 0 && homeRain < 3
                                      ? 'home_card_message_6'.trParams(
                                          {'status': homeWeatherStatusText})
                                      : homeRain >= 3 && homeRain < 8
                                          ? 'home_card_message_7'.trParams(
                                              {'status': homeWeatherStatusText})
                                          : homeRain >= 8 && homeRain < 12
                                              ? 'home_card_message_8'.trParams({
                                                  'status':
                                                      homeWeatherStatusText
                                                })
                    ...
                    Row(
                      children: [
                        HeyCustomButton.tagWithIcon(context,
