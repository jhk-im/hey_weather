...
class TranslationsInfo extends Translations {
  ...
  final Map<String, String> ko = {
    ...
    'home_card_message_13': '미세먼지가 나쁨 단계로 마스크를 챙기면 좋아요',
    'home_card_message_14': '미세먼지가 매우 나쁨 단계로 마스크를 꼭 챙겨요',
    'home_card_message_15': '초미세먼지가 나쁨 단계로 마스크를 꼭 챙겨요',
    'home_card_message_16': '초미세먼지가 매우 나쁨 단계로 마스크를 꼭 챙겨요',
  };
}
